...
window.OLYMPOS_I18N = (() => {
  ...
  const T = {
    tr: {
      ...
      email: {
        confirmSubject: 'OLYMPOS Leather — Siparişiniz Alındı ({number})',
        ...
        statusSubjectPreparing: 'OLYMPOS Leather — Siparişiniz Hazırlanıyor ({number})',
        statusSubjectShipped: 'OLYMPOS Leather — Siparişiniz Kargoya Verildi ({number})',
        statusSubjectDelivered: 'OLYMPOS Leather — Siparişiniz Teslim Edildi ({number})',
        statusSubjectReceived: 'OLYMPOS Leather — Siparişiniz Alındı ({number})',
      ...
      profile: {
        ...
        subtitle: 'Ad soyad, e-posta ve şifrenizi buradan güncelleyebilirsiniz.',
        ...
        addressesTitle: 'Adreslerim', addressesSubtitle: 'Sipariş verirken seçebileceğiniz adresler.',
        addAddress: '+ Yeni Adres Ekle', editAddress: 'Düzenle', deleteAddress: 'Sil',
        deleteAddressConfirm: 'Bu adresi silmek istediğinize emin misiniz?',
        noAddressesYet: 'Henüz kayıtlı adresiniz yok.',
        addressNameLabel: 'Adres Adı', addressNamePlaceholder: 'Örn. Ev, İş',
        saveAddressButton: 'Adresi Kaydet', cancelButton: 'Vazgeç', addressSaving: 'Kaydediliyor…',
        addressSaved: 'Adres kaydedildi.', addressDeleted: 'Adres silindi.'
      },
      cartPage: {
      ...
      checkout: {
        ...
        addressLabel: 'Adres', cityLabel: 'Şehir', cityPlaceholder: 'Şehir seçin', zipLabel: 'Posta Kodu',
        provinceLabel: 'İl', provincePlaceholder: 'İl seçin',
        districtLabel: 'İlçe', districtPlaceholder: 'İlçe seçin',
        neighborhoodLabel: 'Mahalle', neighborhoodPlaceholder: 'Mahalle seçin',
        streetLabel: 'Sokak', noLabel: 'No', floorLabel: 'Kat', doorLabel: 'Daire',
        savedAddressesTitle: 'Kayıtlı Adreslerim', useNewAddress: '+ Yeni Adres Kullan',
        saveThisAddress: 'Bu adresi hesabıma kaydet', addressNameOptional: 'Adres Adı (opsiyonel)', addressNamePlaceholder: 'Örn. Ev, İş',
    ...
    en: {
      ...
      email: {
        confirmSubject: 'OLYMPOS Leather — Your Order Was Received ({number})',
        ...
        statusSubjectPreparing: 'OLYMPOS Leather — Your Order Is Being Prepared ({number})',
        statusSubjectShipped: 'OLYMPOS Leather — Your Order Has Shipped ({number})',
        statusSubjectDelivered: 'OLYMPOS Leather — Your Order Was Delivered ({number})',
        statusSubjectReceived: 'OLYMPOS Leather — Your Order Was Received ({number})',
      ...
      profile: {
        ...
        subtitle: 'Update your name, email, and password here.',
        ...
        addressesTitle: 'My Addresses', addressesSubtitle: 'Addresses you can pick from at checkout.',
        addAddress: '+ Add New Address', editAddress: 'Edit', deleteAddress: 'Delete',
        deleteAddressConfirm: 'Are you sure you want to delete this address?',
        noAddressesYet: 'You don’t have any saved addresses yet.',
        addressNameLabel: 'Address Name', addressNamePlaceholder: 'e.g. Home, Work',
        saveAddressButton: 'Save Address', cancelButton: 'Cancel', addressSaving: 'Saving…',
      ...
      checkout: {
        ...
        addressLabel: 'Address', cityLabel: 'City', cityPlaceholder: 'Select a city', zipLabel: 'Postal Code',
        provinceLabel: 'Province', provincePlaceholder: 'Select a province',
        districtLabel: 'District', districtPlaceholder: 'Select a district',
        neighborhoodLabel: 'Neighborhood', neighborhoodPlaceholder: 'Select a neighborhood',
        streetLabel: 'Street', noLabel: 'No.', floorLabel: 'Floor', doorLabel: 'Apt./Door',
        savedAddressesTitle: 'Saved Addresses', useNewAddress: '+ Use a New Address',
        saveThisAddress: 'Save this address to my account', addressNameOptional: 'Address Name (optional)', addressNamePlaceholder: 'e.g. Home, Work',
    ...
    de: {
      ...
      email: {
        confirmSubject: 'OLYMPOS Leather — Ihre Bestellung ist eingegangen ({number})',
        ...
        statusSubjectPreparing: 'OLYMPOS Leather — Ihre Bestellung wird vorbereitet ({number})',
        statusSubjectShipped: 'OLYMPOS Leather — Ihre Bestellung wurde versandt ({number})',
        statusSubjectDelivered: 'OLYMPOS Leather — Ihre Bestellung wurde zugestellt ({number})',
        statusSubjectReceived: 'OLYMPOS Leather — Ihre Bestellung ist eingegangen ({number})',
      ...
      profile: {
        ...
        subtitle: 'Aktualisieren Sie hier Ihren Namen, Ihre E-Mail-Adresse und Ihr Passwort.',
        ...
        addressesTitle: 'Meine Adressen', addressesSubtitle: 'Adressen, die Sie beim Checkout auswählen können.',
        addAddress: '+ Neue Adresse hinzufügen', editAddress: 'Bearbeiten', deleteAddress: 'Löschen',
        deleteAddressConfirm: 'Möchten Sie diese Adresse wirklich löschen?',
        noAddressesYet: 'Sie haben noch keine gespeicherten Adressen.',
        addressNameLabel: 'Adressname', addressNamePlaceholder: 'z. B. Zuhause, Arbeit',
        saveAddressButton: 'Adresse speichern', cancelButton: 'Abbrechen', addressSaving: 'Wird gespeichert…',
        addressSaved: 'Adresse gespeichert.', addressDeleted: 'Adresse gelöscht.'
      },
      cartPage: {
      ...
      checkout: {
        ...
        addressLabel: 'Adresse', cityLabel: 'Stadt', cityPlaceholder: 'Stadt wählen', zipLabel: 'Postleitzahl',
        provinceLabel: 'Provinz', provincePlaceholder: 'Provinz wählen',
        districtLabel: 'Bezirk', districtPlaceholder: 'Bezirk wählen',
        neighborhoodLabel: 'Stadtviertel', neighborhoodPlaceholder: 'Stadtviertel wählen',
        streetLabel: 'Straße', noLabel: 'Nr.', floorLabel: 'Stock', doorLabel: 'Wohnungsnr.',
        savedAddressesTitle: 'Gespeicherte Adressen', useNewAddress: '+ Neue Adresse verwenden',
        saveThisAddress: 'Diese Adresse in meinem Konto speichern', addressNameOptional: 'Adressname (optional)', addressNamePlaceholder: 'z. B. Zuhause, Arbeit',
